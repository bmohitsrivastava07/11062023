...
import ProductModel from "../../Models/ProductModel";import ReviewModel from '../../Models/ReviewModel';
...
export const ProductCheckoutPage=()=>{
    ...
    useEffect(()=>{
        const fetchProductReviews=async()=>{
            const reviewUrl: string =`http://localhost:8081/reivews/search/findByProductId?productId=${productId}`;
            ...
            <div className="container d-none d-lg-block">
                <div className="row mt-5">
                    <div className="col-sm-2 col-md-2">
                        {product?.image ? <img src={product?.image} width='226' height="349" alt='Art'/>
                        :
